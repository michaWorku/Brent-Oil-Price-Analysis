// Displays a line chart of the raw Brent oil prices.
...
const PriceChart = ({ data, changePointDate }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 h-96">
      <h2 className="text-2xl font-semibold text-gray-800 mb-4">Historical Brent Oil Prices</h2>
        ...
        <LineChart data={chartData} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
          ...
          {changePointIndex !== -1 && (
            <ReferenceLine 
              ...
              stroke="#ef4444" 
              strokeDasharray="5 5" 
              label={{ value: 'Change Point', position: 'insideTopLeft', fill: '#ef4444' }} 
            />
          )}
        </LineChart>
      </ResponsiveContainer>
